...
export type WebsocketServerMessage = { "type": "TrackerInfo", id: string, info: TrackerInfo, } | { "type": "TrackerData", id: string, data: TrackerData, } | { "type": "InitialState", tracker_infos: { [key: string]: TrackerInfo }, config: GlobalConfig, port_name?: string, } | { "type": "SerialLog", log: string, } | UpdateEvent;
