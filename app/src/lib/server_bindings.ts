...
export type WebsocketClientMessage = { "type": "SerialSend", data: string, } | { "type": "RemoveTracker", id: string, } | { "type": "UpdateConfig", config: GlobalConfigUpdate, } | { "type": "ResetTrackerOrientations" } | { "type": "StartRecord" } | { "type": "StopRecord", save_path: string, };
