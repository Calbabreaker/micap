 ...
 */
tail_offset: [number, number, number], 
/**
 * Orientation of joint
 */
orientation: [number, number, number, number], parent: BoneLocation | null, };
